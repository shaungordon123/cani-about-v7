...
(function () {
  ...
  var CSS = '' +
    ...
    '[data-root]{' +
      ...
      '--pad-y:72px;--pad-x:88px;--gap:112px;--panel-min:210;--stage-zoom:0.85;}' +
    '[data-stage]{zoom:var(--stage-zoom);}' +
    /* Laptop band */
    '@media (max-width:1599px){[data-root]{--h1:clamp(64px,4.5vw,72px);--stage-zoom:0.84;--gap:104px;}}' +
    /* Tablet band (also the single-column collapse range) */
    '@media (max-width:1150px){[data-root]{--h1:clamp(46px,5vw,56px);--stage-zoom:0.88;--pad-y:56px;}}' +
    /* Mobile band */
    '@media (max-width:767px){[data-root]{--h1:clamp(36px,10.5vw,44px);--h3:22px;--body-lg:17px;--stage-zoom:0.9;--pad-y:48px;--panel-min:0;}}' +
  ...
  '<div data-root style="position:relative;overflow:hidden;background:#fff;">' +
    ...
    '<section data-exp aria-label="The my.plan platform" style="position:relative;z-index:1;display:grid;grid-template-columns:1.02fr 1fr;gap:var(--gap);max-width:1520px;margin:0 auto;padding:0 var(--pad-x);align-items:center;min-height:calc(100vh - 116px);">' +
      ...
      '<div data-acts style="padding:var(--pad-y) 0;display:flex;flex-direction:column;align-items:flex-start;">' +
        ...
        '<div data-segwrap style="width:100%;max-width:580px;margin-top:var(--m-seg);background:#F0F0F2;border-radius:12px;padding:4px;">' +
