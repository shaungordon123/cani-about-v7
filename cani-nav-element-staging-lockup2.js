...
/* MODIFIED 2026-06-18 (STAGING ONLY): "Resources" converted from a bare label into a
   ...
   DG-TOPLEVEL 2026-08-10 (CANIREV:device-guides-toplevel-20260810): directly
   visible Device Guides links now sit immediately before Contact on desktop
   (.cani-link, identical treatment) and immediately above Contact in the
   mobile drawer (.strong row). Resources -> Device Guides preserved.
   Rollback: repoint the header custom element to
   cani-nav-element-staging.js?v=phone-03300580389-2 (SHA AE3A83E0..., 48,745 B).
...
.cani-logo{display:flex;align-items:center;flex:0 0 auto;text-decoration:none;}
...
@media (max-width:880px){.cani-nav{--bar-h:78px;}.cani-logo img{width:136px;}.cani-lockup{gap:4px;}.cani-lockup__sub{font-size:8.5px;}} /* LOGO181:+10% (2026-07-25, was 39.6px => 39.6 x 1.10 = 43.56px; operator-confirmed base = true current 116.09x39.59 => target ~127.7x43.55). Same master vector canilogovectormaster-v2.svg (tight viewBox 119 341 1522 519, aspect 2.9326); width:auto preserves aspect. Vertically centred + left-anchored in the 84.88px bar. Prior LOGO165 note: 31.68 x 1.25 = 39.6 (master-vector swap). */

.cani-links{display:flex;align-items:center;gap:4px;}
.cani-link{white-space:nowrap;font-size:14px;font-weight:600;color:var(--txt-dim);text-decoration:none; /* NAV-1PX 2026-07-25: 15px -> 14px (desktop labels only) */
...
<a class="cani-link" href="https://shaungordon3.wixstudio.com/my-site-4/device-guides" target="_top">Device Guides</a>
...
<a class="strong" href="https://shaungordon3.wixstudio.com/my-site-4/device-guides" target="_top">Device Guides</a>
