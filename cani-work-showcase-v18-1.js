/*
 * <cani-8x8-work-showcase>  --  VERSION V18.1
 *
...
(function () {
  ...
  var CSS = [
    ...
    '.messages-scene .msg-head{display:flex;align-items:center;gap:6px;padding:4px 10px 7px;border-bottom:1px solid #ececef;}',
    ...
    '.incoming-scene .spx-tabs span{font-size:7px;color:#8a8a92;padding-bottom:3px}',
    '.incoming-scene .spx-tabs .on{color:#17171c;font-weight:700;box-shadow:inset 0 -1.5px 0 #e6007e}',
    '.incoming-scene .spx-search{font-size:6.5px;color:#a4a4ac;background:#f4f4f6;border-radius:4px;padding:3px 6px;margin-bottom:5px}',
    '.incoming-scene .spx-sect{font-size:6px;letter-spacing:.1em;text-transform:uppercase;color:#a4a4ac;margin:4px 2px 3px}',
    '.incoming-scene .spx-row{display:flex;align-items:center;gap:5px;padding:2.2px 2px;}',
    ...
    '.incoming-scene .spx-rt small{font-size:6px;color:#a4a4ac}',
    '.incoming-scene .spx-row em{font-size:6px;color:#a4a4ac;font-style:normal}',
    ...
    '.incoming-scene .spx-dial-h{font-size:6px;color:#a4a4ac}',
    '.incoming-scene .spx-dial-num{font-size:8.5px;color:#17171c;font-weight:600;letter-spacing:.02em}',
    '.incoming-scene .spx-pad{display:grid;grid-template-columns:repeat(3,1fr);gap:4px;width:100%;margin:4px 0 3px}',
    '.incoming-scene .spx-pad span{font-size:8px;color:#3a3a41;text-align:center;padding:1px 0}',
    ...
    '.meeting-scene .mtx-file{display:flex;align-items:center;gap:5px;background:#1d2026;border-radius:5px;padding:4px 5px}',
    ...
    '.meeting-scene .mtx-file b{font-size:6px;color:#dfe2e8;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
    '.meeting-scene .mtx-file em{font-size:5.5px;color:#8a8f99;font-style:normal}',
