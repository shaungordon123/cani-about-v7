...
@media (max-width:880px){.cani-nav{--bar-h:78px;}.cani-logo img{width:136px;}.cani-lockup{gap:4px;}.cani-lockup__sub{font-size:8.5px;letter-spacing:0.20em;margin-right:-0.20em;}} /* LOGO181:+10% (2026-07-25, was 39.6px => 39.6 x 1.10 = 43.56px; operator-confirmed base = true current 116.09x39.59 => target ~127.7x43.55). Same master vector canilogovectormaster-v2.svg (tight viewBox 119 341 1522 519, aspect 2.9326); width:auto preserves aspect. Vertically centred + left-anchored in the 84.88px bar. Prior LOGO165 note: 31.68 x 1.25 = 39.6 (master-vector swap). */
