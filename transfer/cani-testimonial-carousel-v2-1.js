...
(function () {
  ...
  var CSS = '' +
    ...
    ':host([data-rv="revealed"]) .brandrow{animation:caniTc2Rise 620ms cubic-bezier(0.22,1,0.36,1) 0ms both;}' +
    ':host([data-rv="revealed"]) .viewport{animation:caniTc2Rise 700ms cubic-bezier(0.22,1,0.36,1) 120ms both;}' +
    ':host([data-rv="revealed"]) .controls{animation:caniTc2Rise 620ms cubic-bezier(0.22,1,0.36,1) 240ms both;}' +
  ...
  function initReveal(host) {
    try {
      ...
      var reveal = function () {
        ...
        var gateWait = rvGate('testimonial', 700);
