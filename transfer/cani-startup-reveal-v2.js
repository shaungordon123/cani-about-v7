/*
 * <cani-startup-reveal> -- VERSION V2 (premium rework)
...
(function () {
  ...
  CaniStartup.prototype.connectedCallback = function () {
    ...
    function finish(reason) {
      if (finished) return;
      finished = true;
      safe(function () { if (!timings.reason) timings.reason = reason; if (timings.overlayClear === null) timings.overlayClear = Math.round(((window.performance && performance.now) ? performance.now() : Date.now()) - (window.__caniT0 || 0)); });
    ...
    function frame() {
      ...
      if (t >= 4550) { renderOdometer(100); fastExit('fail-open-4550'); return; }
    ...
    var guardTimer = setTimeout(function () { fastExit('guard-4700'); }, 4700);
